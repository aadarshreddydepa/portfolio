  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center mb-4 z-10">
        ...
        <motion.div
          style={{ rotate }}
          className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px] mix-blend-screen opacity-80"
        >
          <Image
            src="/Images/blob.png"
            alt="Organic 3D Blob"
        ...
        <div className="absolute top-[60%] flex flex-col items-center w-full">
          <div className="flex flex-col items-center justify-center px-8 py-4">
            ...
            <h2 className="text-5xl md:text-7xl font-serif text-white text-center drop-shadow-2xl whitespace-nowrap">
              The Secret{" "}
              <span className="italic bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
                Sauce
              </span>
            </h2>
          </div>
