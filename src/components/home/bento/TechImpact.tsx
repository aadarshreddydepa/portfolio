    ...
    <div className="flex overflow-hidden relative w-full py-2">
      ...
      >
        {[...items, ...items, ...items, ...items].map((tech, index) => (
          <div
            key={index}
            className="flex items-center gap-3 px-9 py-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
          >
  ...
  return (
    <div className="h-full flex flex-col bg-[#0a0a0a] border border-white/10 rounded-3xl relative overflow-hidden">
      ...
      <div className="p-8 pb-0 relative z-20 w-full min-w-0">
        ...
        <div className="flex flex-col gap-4 mb-8 -mx-4 w-[calc(100%+2rem)]">
      ...
      <div className="flex-1 relative mt-4 mx-8 group">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[120%] bg-[#111] border border-white/10 rounded-2xl shadow-2xl transition-transform duration-500 group-hover:-translate-y-4">
          {/* Browser Header */}
