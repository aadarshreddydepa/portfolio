  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center mb-4 z-10">
        ...
        <motion.div
          style={{ rotate }}
          className="relative w-[280px] h-[280px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] mix-blend-screen opacity-80 will-change-transform"
        >
          <Image
            src="/Images/blob.png"
            alt="Organic 3D Blob"
        ...
        <div className="absolute top-[60%] flex flex-col items-center w-full">
          <div className="flex flex-col items-center justify-center px-8 py-4">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-instrument text-white text-center drop-shadow-2xl whitespace-normal md:whitespace-nowrap">
              The Secret{" "}
