...
export default function Impact() {
  return (
    <div className="h-full flex flex-col p-8 bg-[#0a0a0a] border border-white/10 rounded-3xl relative overflow-hidden group">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[90%] h-[80%] bg-[#111] border border-white/10 rounded-t-xl shadow-2xl transition-transform duration-500 group-hover:-translate-y-2">
        {/* Browser Header */}
